...
jQuery(document).ready(function () {
	...
	tinymce.init({
		...
		toolbar: "undo redo formatselect bold italic underline justifyleft justifycenter justifyright justifyfull outdent indent image code link",
		relative_urls: false,
		remove_script_host: false,
		convert_urls: true,
		entity_encoding: 'raw',
		plugins: "image imagetools table code link",
